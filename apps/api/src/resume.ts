export type ResumeCheckpoint="QUEUED"|"RESEARCHING"|"CODING"|"TESTING"|"REVIEWING"|"AWAITING_HUMAN_APPROVAL";
...
export function resumeCheckpoint(task:CheckpointTask):ResumeCheckpoint{
  ...
  if(reviewReport?.decision==="approve"&&testReport?.passed&&task.diff&&task.approvalHash)return "AWAITING_HUMAN_APPROVAL";
