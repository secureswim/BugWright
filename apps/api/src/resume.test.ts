...
const empty={managerPlan:null,researchReport:null,patchProposal:null,testReport:null,reviewReport:null,diff:null,approvalHash:null};
...
describe("resumeCheckpoint",()=>{
  it.each([
    ...
    [{...empty,patchProposal:{},diff:"patch",testReport:{passed:true},reviewReport:{decision:"approve"},approvalHash:"hash"},"AWAITING_HUMAN_APPROVAL"],
