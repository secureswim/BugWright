...
export interface ManagerDecision {
  next: "RESEARCHER" | "CODER" | "TESTER" | "REVIEWER" | "HUMAN_APPROVAL" | "NEEDS_ATTENTION";
  reason: string;
...
export const managerDecisionSchema = z.object({
  next: z.enum(["RESEARCHER", "CODER", "TESTER", "REVIEWER", "HUMAN_APPROVAL", "NEEDS_ATTENTION"]),
  reason: z.string(),
...
export const reviewReportSchema = z.object({
  ...
  findings: z.array(
    z.object({ severity: z.enum(["info", "warning", "blocking"]), title: z.string(), evidence: z.string() }),
  ),
